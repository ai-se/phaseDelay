...
\title{Delaying Bug Fixes is a Bad Idea?}
\numberofauthors{3}
\author{
%\alignauthor 
Tim Menzies \\
...
\end{tabular}
\end{center}}
\caption{Sample of the Stecklein et al. literature; from~\cite{steck04}.}
\end{figure}
...
\begin{figure}[!t]  
\begin{center}
\includegraphics[angle=270,width=3.5in]{img/b81.pdf}
 \end{center}
 \caption{From Boehm~\cite{Boehm81}. }\label{fig:cost-to-fix-tsp}
 \end{figure}
