\todo{
\bi
    \item fig6 looks a little gray. can we make the black there darker?
\ei
}
...
\begin{figure}[!ht]
 ...
 \caption{Exception to the rule - CCPDS-R case study cost-to-fix curve. From~\cite{Royce98}. \lucas{will get a better picture if we leave this in.}}\label{fig:royce}
 \end{figure}
