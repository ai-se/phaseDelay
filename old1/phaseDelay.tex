...
the  time  to resolve 
issues in a later phase was {\bf not} consistently  more than  
...
of the importance of theory building [Sjoberg08, Paivarinta15, Stol15]. A good theory allows empirical research to go beyond simply
reporting observations and instead provides explanations for why results are observed [Stol15]. Theory-building needs to be an iterative process,
in which results from practice are used to refine theories and theories are used to inform future observation and data collection [Paivarinta15, Stol15]. 
It is no coincidence that it  
is standard practice
in other fields, such as medicine,
to continually revisit old conclusions in the light of new theories and new understanding~\cite{prasad13}.

Accordingly, this paper revisits
a fundamental software engineering theory, the {\em delayed issue effect} (hereafter, DIE).
...
This theory has been used as the basis for decision-making in software engineering. For example, Basili \& Boehm comment that since the 1980s,  this effect
 \begin{quote}
